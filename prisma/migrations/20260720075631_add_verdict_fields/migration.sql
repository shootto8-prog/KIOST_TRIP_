...
INSERT INTO "new_Receipt" ("category", "createdAt", "id", "imagePath", "ocrAmountGuess", "ocrDateGuess", "ocrMerchantGuess", "ocrModel", "ocrStatus", "ocrText", "transportMode", "tripId") SELECT "category", "createdAt", "id", "imagePath", "ocrAmountGuess", "ocrDateGuess", "ocrMerchantGuess", "ocrModel", "ocrStatus", "ocrText", "transportMode", "tripId" FROM "Receipt";
DROP TABLE "Receipt";
