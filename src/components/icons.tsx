export function IconBreakfast({ className = "size-7" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} strokeWidth={1.6} stroke="currentColor">
      <path
        d="M4 9h13a3 3 0 0 1 0 6h-1M4 9v6a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2V9M4 9V6a1 1 0 0 1 1-1h1M9 5V3M12 5V3M15 5V3"
        strokeLinecap="round"
...
export function IconTransport({ className = "size-7" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} strokeWidth={1.6} stroke="currentColor">
      <path
        d="M3 13.5 10.5 11 14 4l1.7.6-1.9 6.4 4.7-1.7a2 2 0 0 1 2.6 1.9c0 .9-.6 1.6-1.4 1.9L4.8 18 3 16.8v-3.3Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
export function IconLodging({ className = "size-7" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} strokeWidth={1.6} stroke="currentColor">
      <path
        d="M3 19v-9M3 13h17a1 1 0 0 1 1 1v5M3 13V7a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6M8 10.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
export function IconCamera({ className = "size-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} strokeWidth={1.6} stroke="currentColor">
      <path
...
export function IconPhoto({ className = "size-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} strokeWidth={1.6} stroke="currentColor">
...
export function IconPdf({ className = "size-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} strokeWidth={1.6} stroke="currentColor">
      <path
